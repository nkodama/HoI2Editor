    ...
    public static class TechParser
    {
        ...
        public static TechGroup Parse(string fileName)
        {
            ...
            using (var lexer = new TextLexer(fileName, true))
            {
                ...
                {
                    Log.Warning("[Tech] Invalid token: {0}", ObjectHelper.ToString(token.Value));
                    return null;
                }
                ...
                if (group == null)
                {
                    Log.Warning("[Tech] Parse failed: technology section");
                }
                return group;
            }
        }
        ...
        private static TechGroup ParseTechnology(TextLexer lexer)
        {
            ...
            while (true)
            {
                ...
                if (keyword.Equals("label"))
                {
                    ...
                    if (label == null)
                    {
                        Log.Warning("[Tech] Parse failed: label section");
                        continue;
                    }
                ...
                if (keyword.Equals("event"))
                {
                    ...
                    if (ev == null)
                    {
                        Log.Warning("[Tech] Parse failed: event section");
                        continue;
                    }
                ...
                if (keyword.Equals("application"))
                {
                    ...
                    if (application == null)
                    {
                        Log.Warning("[Tech] Parse failed: application section");
                        continue;
                    }
        ...
        private static TechItem ParseApplication(TextLexer lexer)
        {
            ...
            while (true)
            {
                ...
                if (keyword.Equals("position"))
                {
                    ...
                    if (position == null)
                    {
                        Log.Warning("[Tech] Parse failed: position section");
                        continue;
                    }
                ...
                if (keyword.Equals("component"))
                {
                    ...
                    if (component == null)
                    {
                        Log.Warning("[Tech] Parse failed: component section");
                        continue;
                    }
                ...
                if (keyword.Equals("required"))
                {
                    ...
                    if (ids == null)
                    {
                        Log.Warning("[Tech] Parse failed: required section");
                        continue;
                    }
                ...
                if (keyword.Equals("or_required"))
                {
                    ...
                    if (ids == null)
                    {
                        Log.Warning("[Tech] Parse failed: or_required section");
                        continue;
                    }
                ...
                if (keyword.Equals("effects"))
                {
                    ...
                    if (commands == null)
                    {
                        Log.Warning("[Tech] Parse failed: effects section");
                        continue;
                    }
        ...
        private static IEnumerable<Command> ParseEffects(TextLexer lexer)
        {
            ...
            while (true)
            {
                ...
                if (keyword.Equals("command"))
                {
                    ...
                    if (command == null)
                    {
                        Log.Warning("[Tech] Parse failed: command section");
                        continue;
                    }
