...
namespace HoI2Editor.Models
{
    ...
    public class ScenarioCountryInfo
    {
        ...
        /// マップ外資源
        /// </summary>
        public CountryResourceInfo Free { get; set; }

        /// <summary>
        /// 外交情報
        /// </summary>
        public List<CountryRelationInfo> Diplomacy { get; private set; }

        /// <summary>
        /// 諜報情報
        /// </summary>
        public List<CountrySpyInfo> Intelligence { get; private set; }
        ...
        /// 政策スライダー
        /// </summary>
        public CountryPolicy Policies { get; private set; }

        /// <summary>
        /// 閣僚
        /// </summary>
        public CountryMinisterInfo Ministers { get; private set; }
        ...
        {
            Diplomacy = new List<CountryRelationInfo>();
            Intelligence = new List<CountrySpyInfo>();
            ...
            Policies = new CountryPolicy();
            Ministers = new CountryMinisterInfo();
        }
    ...
    /// 国家資源情報
    /// </summary>
    public class CountryResourceInfo
    {
        #region 公開プロパティ
    ...
    /// 国家関係情報
    /// </summary>
    public class CountryRelationInfo
    {
        #region 公開プロパティ
    ...
    /// 国家閣僚情報
    /// </summary>
    public class CountryMinisterInfo
    {
        #region 公開プロパティ
