...
namespace HoI2Editor.Forms
{
    ...
    internal partial class MinisterEditorForm : Form
    {
        ...
        private void OnBatchButtonClick(object sender, EventArgs e)
        {
            ...
            // 一括編集ダイアログを表示する
            MinisterBatchDialog dialog = new MinisterBatchDialog(_controller, args);
            ...
            if (args.Items[(int) MinisterBatchItemId.EndYear] && !Misc.UseNewMinisterFilesFormat)
            {
                ...
                _controller.NotifyItemChange(EditorItemId.MinisterEndYear);
            }
            ...
            if (args.Items[(int) MinisterBatchItemId.RetirementYear] && !Misc.EnableRetirementYearMinisters)
            {
                ...
                _controller.NotifyItemChange(EditorItemId.MinisterRetirementYear);
            }
