...
namespace HoI2Editor.Controllers
{
    ...
    ///     ユニット名エディタコントローラ
    /// </summary>
    internal class UnitNameEditorController
    {
        #region 公開プロパティ
        ...
        ///     フォーム
        /// </summary>
        private UnitNameEditorForm _form;
        ...
        internal UnitNameEditorController(HoI2EditorInstance instance)
        {
            _instance = instance;
        }
        ...
        internal void OpenForm()
        {
            if (_form == null)
            {
                _form = new UnitNameEditorForm(this);
                _form.Show();
            }
            else
            {
