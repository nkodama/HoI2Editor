...
namespace HoI2Editor.Controllers
{
    ...
    ///     プロヴィンスエディタコントローラ
    /// </summary>
    internal class ProvinceEditorController
    {
        #region 内部フィールド
        ...
        ///     フォーム
        /// </summary>
        private ProvinceEditorForm _form;
        ...
        internal ProvinceEditorController(HoI2EditorInstance instance)
        {
            _instance = instance;
        }
        ...
        internal void OpenForm()
        {
            if (_form == null)
            {
                _form = new ProvinceEditorForm(this);
                _form.Show();
            }
            else
            {
