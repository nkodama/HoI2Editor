...
namespace HoI2Editor.Controllers
{
    ...
    ///     指揮官エディタコントローラ
    /// </summary>
    internal class LeaderEditorController
    {
        #region 公開プロパティ
        ...
        ///     フォーム
        /// </summary>
        private LeaderEditorForm _form;
        ...
        internal LeaderEditorController(HoI2EditorInstance instance)
        {
            _instance = instance;
        }
        ...
        internal void OpenForm()
        {
            if (_form == null)
            {
                _form = new LeaderEditorForm(this);
                _form.Show();
            }
            else
            {
