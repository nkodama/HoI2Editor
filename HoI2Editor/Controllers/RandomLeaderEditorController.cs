...
namespace HoI2Editor.Controllers
{
    ...
    ///     ランダム指揮官名エディタコントローラ
    /// </summary>
    internal class RandomLeaderEditorController
    {
        #region 公開プロパティ
        ...
        ///     フォーム
        /// </summary>
        private RandomLeaderEditorForm _form;
        ...
        internal RandomLeaderEditorController(HoI2EditorInstance instance)
        {
            _instance = instance;
        }
        ...
        internal void OpenForm()
        {
            if (_form == null)
            {
                _form = new RandomLeaderEditorForm(this);
                _form.Show();
            }
            else
            {
